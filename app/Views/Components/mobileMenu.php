                ...
                <div class="offcanvas-content">
                    <div class="offcanvas-top d-flex justify-content-between align-items-center mb-20">
                        <div class="offcanvas-logo">
                            <a class="logo-black" href="<?= base_url() ?>"><img src="<?= base_url() ?>public/assets/images/logo/srm-dark-logo.png" alt="logo"></a>
                        </div>
                    ...
                    <div class="offcanvas-about mb-30 d-none d-sm-block">
                        <p> Our products are tailored for performance, durability, and seamless integration into modern industry operations.
                        </p>
                    </div>
                        ...
                        <ul>
                            <li class="d-flex align-items-center gap-15">
                                ...
                                <div class="offcanvas-contact-text">
                                    <a href="#"> Thekupalayam, Coimbatore. </a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center gap-15">
                                <div class="offcanvas-contact-icon">
                                ...
                                <div class="offcanvas-contact-text">
                                    <a href="tel:+91 94885 22011"> +91 94885 22011 </a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center gap-15">
                                <div class="offcanvas-contact-icon">
                                ...
                                <div class="offcanvas-contact-text">
                                    <a href="mailto:info@gmail.com">info@srmhydraulics.in</a>
                                </div>
                            </li>
                        </ul>
                    </div>
