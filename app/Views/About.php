    ...
    <main>
        ...
        <section class="rs-team-area section-space rs-team-one custom-team-area">
            <div class="container">
                ...
                <div class="row g-5 custom-team-member">
                        ...
                        <div class="rs-team-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            ...
                            <div class="rs-team-content-wrapper">
                                <div class="rs-team-content-box">
                                    <h5 class="rs-team-title"><a href="#">Mr. G. Santhosh Kumar</a></h5>
                                    <span class="rs-team-designation">Founder</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="rs-history-tab-content">
                                                ...
                                                <div class="rs-history-tab-list">
                                                    <div class="rs-list-item">
                                                        <ul>
                                                            <li>
                                                                Established core engineering unit.
                                                            </li>
                                                            <li>
                                                                First line of hydraulic cylinders delivered.
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="rs-history-tab-content">
                                                ...
                                                <div class="rs-history-tab-list">
                                                    <div class="rs-list-item">
                                                        <ul>
                                                            <li>
                                                                Increased capacity for industrial orders.
                                                            </li>
                                                            <li>
                                                                Building Quality for Industries.
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="rs-history-tab-content">
                                                ...
                                                <div class="rs-history-tab-list">
                                                    <div class="rs-list-item">
                                                        <ul>
                                                            <li>
                                                                National client network established

                                                            </li>
                                                            <li>
                                                                Large-scale fabrication projects executed
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="rs-history-tab-content">
                                                ...
                                                <div class="rs-history-tab-list">
                                                    <div class="rs-list-item">
                                                        <ul>
                                                            <li>
                                                                Integrated digital design systems.
                                                            </li>
                                                            <li>
                                            ...
                                            <div class="rs-history-tab-content">
                                                ...
                                                <div class="rs-history-tab-list">
                                                    <div class="rs-list-item">
                                                        <ul>
                                                            <li>
                                                                Export operations launching.
                                                            </li>
                                                            <li>
                                                                Smart cylinder R&D in progress.
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
