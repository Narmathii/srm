    ...
    <main>
                    ...
                    <div class="col-xl-7 col-lg-7">
                        <div class="rs-contact-wrapper">
                            <div class="rs-section-title-wrapper">
                                <span
                                    class="rs-section-subtitle has-theme-orange justify-content-start custom-rs-section">
                                ...
                                <h2 class="rs-section-title mb-30 rs-split-text-enable split-in-fade">Contact SRM
                                    Hydraulics - Industrial Press Machine and Powerpack</h2>
                                <p class="descrip">
                                    Reach SRM Hydraulics for industrial press machines in Coimbatore, hydraulic
                                    powerpack supply, and comprehensive hydraulic equipment solutions. Our Coimbatore
                                    facility serves clients throughout Tamil Nadu with reliable products and
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="rs-contact-form wow fadeInRight" data-wow-delay=".5s" data-wow-duration="1s">
                            <div class="rs-contact-form-bg-thumb"
                                data-background="<?= base_url() ?>public/assets/images/bg/contact-bg-03.png"></div>
                            <h3 class="rs-contact-form-title">Get in Touch</h3>
                            <p class="descrip">Have a project in mind or need expert advice? The SRM Hydraulic team is
        ...
        <div class="rs-map-area rs-map-one">
            <div class="rs-google-map">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d18577.07404307686!2d76.92393675911194!3d11.131131378766673!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba8f6bbc9a0817d%3A0xe5ac898b153ef0c!2sTherkkuppalayam%2C%20Coimbatore%2C%20Tamil%20Nadu!5e1!3m2!1sen!2sin!4v1752140407978!5m2!1sen!2sin"
